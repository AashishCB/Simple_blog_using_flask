...
from simpleblog.core.views import core
from simpleblog.users.views import users
from simpleblog.blog_posts.views import blog_posts
from simpleblog.error_pages.handlers import error_pages
